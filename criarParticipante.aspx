<%@ Page Language="VB" AutoEventWireup="false" CodeFile="criarParticipante.aspx.vb" Inherits="criarParticipante" %>
...
<body>
    ...
    <p>
        ainda sem criar Participantes, proximo update na pagina</p>
     <div class="footer">
